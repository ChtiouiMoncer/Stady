...
const PitchRejection = () => {
    ...
    const PITCHES_URL = `/api/grounds?page=${page}&isRejected=true&owner.username=${auth?.username}`;
  ...
  try {
    ...
    setIsPending(false);
    // Check for the specific error message about reservation here and set your error message accordingly
    
      setErrMsg("There is a problem while deleting the Pitch, Try Again!");
