...
const Reservations = () => {
    ...
    const getReservations = async () => {
        ...
        if (!isMobile) {
          columns.push(
            { field: 'pitchName', headerName: t('UserReservtion.pitch'), width: 100 },
        ...
        columns.push(
          { field: 'date', headerName: 'Date', width: isMobile ? 90 : 100, },
          { field: 'reservationCode', headerName: 'Code', width: isMobile ? 90 : 100,},
          {
            field: 'qr',
            headerName: 'QR Code',
