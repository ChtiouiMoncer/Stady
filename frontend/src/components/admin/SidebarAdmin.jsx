...
import { BookOnline, CheckBox, Close, ExpandLess, ExpandMore, HourglassBottom, StarBorder, SupervisedUserCircle, SupervisedUserCircleTwoTone } from "@mui/icons-material";
                ...
                <List> 
                    ...
                    <ListItem disablePadding>
                        <ListItemButton
                            ...
                            sx={{ color: activeItem === 'Pitches' ? 'green.main' : 'grey.dark'}}
                        >
                            <ListItemIcon>
                                <StadiumIcon sx={{ color: activeItem === 'Pitches' ? 'green.main' : 'grey.dark'}} />
                            </ListItemIcon>
                            <ListItemText 
                              primary="Pitches" 
                              sx={{ marginLeft: '-20px' }} 
                    ...
                    <ListItem disablePadding>
                        <ListItemButton
                            ...
                            sx={{ color: activeItem === 'Admins' ? 'green.main' : 'grey.dark',}}
                            >
                            <ListItemIcon>
                                <SupervisedUserCircleTwoTone sx={{ color: activeItem === 'Admins' ? 'green.main' : 'grey.dark',}} />
                            </ListItemIcon>
                            <ListItemText 
                              primary="Admins" 
                              sx={{ marginLeft: '-20px' }} 
                    ...
                    <ListItem disablePadding>
                        <ListItemButton
                            ...
                            sx={{ color: activeItem === 'Members' ? 'green.main' : 'grey.dark',}}
                            >
                            <ListItemIcon>
                                <AccountCircleIcon sx={{ color: activeItem === 'Members' ? 'green.main' : 'grey.dark',}} />
                            </ListItemIcon>
                            <ListItemText 
                              primary="Members" 
                              sx={{ marginLeft: '-20px' }} 
                    ...
                    <ListItem disablePadding>
                        <ListItemButton
                            ...
                            sx={{ color: activeItem === 'Owners' ? 'green.main' : 'grey.dark',}}
                            >
                            <ListItemIcon>
                                <SupervisedUserCircle sx={{ color: activeItem === 'Owners' ? 'green.main' : 'grey.dark',}} />
                            </ListItemIcon>
                            <ListItemText 
                              primary="Owners" 
                              sx={{ marginLeft: '-20px' }} 
